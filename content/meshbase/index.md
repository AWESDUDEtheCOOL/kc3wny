...
title: "meshbase"
type: "Project"
description: "Weatherized Meshtastic base station for indoor/outdoor use"
publishedAt: "2025-11-18"
heroImage: "/api/content-image?path=meshbase/meshbase_complete.jpg"
figures:
  - src: "/api/content-image?path=meshbase/meshbase_powder-coat.jpg"
    caption: "Case powder coat"
    id: "FIG-001"
  - src: "/api/content-image?path=meshbase/meshbase_case-milling1.jpg"
    caption: "Connector hole milling"
    id: "FIG-002"
  - src: "/api/content-image?path=meshbase/meshbase_case-milling2.jpg"
    caption: "Connector hole boring (ethernet connector only)"
    id: "FIG-003"
  - src: "/api/content-image?path=meshbase/meshbase_electronic-fitup.jpg"
    caption: "Electronics fitup"
    id: "FIG-004"
  - src: "/api/content-image?path=meshbase/meshbase_connectors1.jpg"
    caption: "IP-67 Ethernet & USB-C data connectors"
    id: "FIG-005"
  - src: "/api/content-image?path=meshbase/meshbase_connectors2.jpg"

...
export function ProfessionalMembershipsSection({ sectionNum, sectionTitle }: ProfessionalMembershipsSectionProps) {
  const memberships = [
    {
      name: "IEEE",
          ...
          >
            <div className="relative w-20 h-20 md:w-24 md:h-24 mb-3 flex items-center justify-center flex-shrink-0">
              <Image
                ...
                width={96}
                height={96}
                className={`object-contain brightness-0 transition-all ${membership.scale}`}
              />
            </div>
